# wordpress 5.8.1 for Kubernetes | KubeApps Hub
wordpress 5.8.1 for Kubernetes | KubeApps Hub [![](https://hub.kubeapps.com/assets/images/logo.svg)](/) 

-   [Charts](/charts)

zhaijunfeng2012@gmail.com [Submit your repository](/submit-repository) Sign out

![](https://hub.kubeapps.com/api/chartsvc/v1/assets/bitnami/wordpress/logo)

wordpress 8 stars

Be notified when there is a new version

Subscribe

=========================================================================

5.8.1 - [bitnami](/charts/bitnami)  
...
In [https://github.com/helm/charts/pulls/12642](https://github.com/helm/charts/pulls/12642) the `apiVersion` of the deployment resources was updated to `apps/v1` in tune with the API's deprecated, resulting in compatibility breakage.
...
[Need Helm?](https://helm.sh/docs/intro/quickstart/ "How to install Helm")

![](https://hub.kubeapps.com/assets/images/kubeapps-black-on-white.svg)
 Easily deploy and manage wordpress in your Kubernetes cluster with Kubeapps.  
[Get Started on GitHub](https://github.com/kubeapps/kubeapps/blob/master/docs/user/getting-started.md)

# Further Reading

[Connecting WordPress to an externally managed database using the Service Catalog](https://youtu.be/mowlSkpev0o?t=666)

[Scaling Wordpress In Kubernetes](https://engineering.bitnami.com/articles/scaling-wordpress-in-kubernetes.html)

# Chart Versions

[12.1.25](/charts/bitnami/wordpress/12.1.25) - Oct 28, 2021

[12.1.24](/charts/bitnami/wordpress/12.1.24) - Oct 23, 2021

[12.1.23](/charts/bitnami/wordpress/12.1.23) - Oct 21, 2021

[12.1.21](/charts/bitnami/wordpress/12.1.21) - Oct 14, 2021

[12.1.20](/charts/bitnami/wordpress/12.1.20) - Oct 8, 2021
...
[Bitnami](mailto:containers@bitnami.com)

# Related

[https://github.com/bitnami/bitnami-docker-wordpress](https://github.com/bitnami/bitnami-docker-wordpress)

[https://wordpress.org/](https://wordpress.org/)

#### ![](https://hub.kubeapps.com/assets/images/bitnami-logo.svg)

© Bitnami 2019 | All Rights Reserved. [Terms](/terms-of-service) / [Privacy](https://bitnami.com/privacy)

[twitter](https://twitter.com/bitnami) [github](https://github.com/kubeapps/)

helm repo add bitnami [https://charts.bitnami.com/bitnami](https://charts.bitnami.com/bitnami) 
 [https://hub.kubeapps.com/charts/bitnami/wordpress](https://hub.kubeapps.com/charts/bitnami/wordpress)
